...
%     plot3([0,xEl],[0,yEl],[0,zEl],'b')
    
    
    plot3([0,xEl]/3,[0,yEl/3],[0,zEl/3],'b')
    plot3([xEl*2/3,xEl],[yEl*2/3,yEl],[zEl*2/3,zEl],'b')
    s1 = surf( xOMdiff +xEl,...
            yOMdiff +yEl,...
            zOMdiff +zEl,...
            CB);
...
print(fig2, ['figs' filesep 'Figure1_ELaxes' ], '-dpng', '-r600');
stupid_ratio = 15/16;
myfiguresize = [left, bottom, width*stupid_ratio, height*stupid_ratio];
set(fig2, 'PaperPosition', myfiguresize);
print(fig2, ['figs' filesep 'Figure1_ELaxes'], '-dsvg', '-r600');
