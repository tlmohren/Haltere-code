...
load(['testData' filesep sim.name filesep sim.name '_allData'])
...
print(fig1, ['figs' filesep 'Figure_SICBstrainF' ], '-dpng', '-r600');
stupid_ratio = 15/16;
myfiguresize = [left, bottom, width*stupid_ratio, height*stupid_ratio];
set(fig1, 'PaperPosition', myfiguresize);
print(fig1, ['figs' filesep 'Figure_SICBstrainF' ], '-dsvg');
...
myfiguresize = [left, bottom, width, height/2];
set(fig2, 'PaperPosition', myfiguresize);
print(fig2, ['figs' filesep 'Figure_SICBstrainFsum' ], '-dpng', '-r600');
stupid_ratio = 15/16;
myfiguresize = [left, bottom, width*stupid_ratio, height/2*stupid_ratio];
set(fig2, 'PaperPosition', myfiguresize);
print(fig2, ['figs' filesep 'Figure_SICBstrainFsum' ], '-dsvg');
...
print(fig3, ['figs' filesep 'Figure_SICBstrainFR' ], '-dpng', '-r600');
stupid_ratio = 15/16;
myfiguresize = [left, bottom, width*stupid_ratio, height*stupid_ratio];
set(fig3, 'PaperPosition', myfiguresize);
print(fig3, ['figs' filesep 'Figure_SICBstrainFR' ], '-dsvg');
...
print(fig4, ['figs' filesep 'Figure_SICBstrainFRsum' ], '-dpng', '-r600');
stupid_ratio = 15/16;
myfiguresize = [left, bottom, width*stupid_ratio, height/2*stupid_ratio];
set(fig4, 'PaperPosition', myfiguresize);
print(fig4, ['figs' filesep 'Figure_SICBstrainFRsum' ], '-dsvg');
